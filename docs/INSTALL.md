...
`libzstd-dev` è obbligatoria: senza, `./configure` salta in silenzio il modulo
`_zstd`, e l'API non parte più — lo ZIP delle cartelle (`zipstream-ng`) lo
richiede sempre, non solo quando lo si usa.
